...
export default function HomePage() {
  ...
  async function loadStats() {
    const [{ count: stockTotal }, { count: posedCount }, { count: receptions }, { count: poses }] =
      await Promise.all([
    ...
    setStats({
      ...
      stockDisponible: (stockTotal || 0) - (posedCount || 0),
    ...
    <div className="space-y-6">
      ...
      <div className="grid grid-cols-1 gap-3">
        <Link href="/receptions/new"
          ...
          <div>
            <div className="font-semibold">Nouveau bon de réception</div>
            <div className="text-blue-100 text-sm">Enregistrer une livraison</div>
          </div>
        ...
        <Link href="/poses/new"
          ...
          <div>
            <div className="font-semibold">Nouveau bon de pose</div>
            <div className="text-green-100 text-sm">Enregistrer une installation</div>
          </div>
          <span className="text-2xl">🔧</span>
        </Link>
        <Link href="/stock"
          ...
          <div>
            <div className="font-semibold text-gray-900">Voir le stock</div>
            <div className="text-gray-400 text-sm">État des unités par sous-traitant</div>
          </div>
          <span className="text-2xl">📊</span>
        </Link>
      </div>
